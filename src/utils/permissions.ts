...
export const DEFAULT_PERMISSIONS: Record<UserRole, UserPermissions> = {
  [UserRole.PROPRIETARIO]: {
    ...
    sales_view: true, sales_execute: true, sales_edit: true, sales_void: true, sales_view_margins: true,
  ...
  [UserRole.GERENTE]: {
    ...
    direct_service_view: true, direct_service_execute: true, direct_service_reports: true, direct_service_void: true,
    sales_view: true, sales_execute: true, sales_edit: true, sales_void: true, sales_view_margins: false,
  ...
  [UserRole.COLABORADOR_EFETIVO]: {
    ...
    sales_view: true, sales_execute: true, sales_edit: false, sales_void: false, sales_view_margins: false,
  ...
  [UserRole.COLABORADOR_REMOTO]: {
    ...
    sales_view: true, sales_execute: false, sales_edit: false, sales_void: false, sales_view_margins: true,
